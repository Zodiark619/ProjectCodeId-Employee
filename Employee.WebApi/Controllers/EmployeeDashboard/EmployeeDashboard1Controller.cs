...
namespace Employees.WebApi.Controllers.EmployeeDashboard
{
    ...
    [ApiController]
    public class EmployeeDashboard1Controller : ControllerBase
    {
        private readonly IRepositoryManager _repository;
        private readonly ILoggerManager _logger;
        private readonly IMapper _mapper;

        public EmployeeDashboard1Controller(IRepositoryManager repository, ILoggerManager logger, IMapper mapper)
        {
